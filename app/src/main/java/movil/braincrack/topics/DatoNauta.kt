...
@Composable
fun DatoNautaView(navegar: NavController, name: String) {
    ...
    val temaExactaManiaca = suddenDeathViewModel.temas.find { it.nombre == "Dato_Nauta" }
    ...
    if (preguntasRestantes.isNotEmpty()) {
        Box(
            ...
            Image(
                painter = painterResource(id = R.drawable.dato_nauta),
