...
@Composable
fun LombiletrasView(navegar: NavController, name: String) {
    ...
    val temaExactaManiaca = suddenDeathViewModel.temas.find { it.nombre == "Lombiletras" }
    ...
    if (preguntasRestantes.isNotEmpty()) {
        Box(
            ...
            Image(
                painter = painterResource(id = R.drawable.lombiletras),
