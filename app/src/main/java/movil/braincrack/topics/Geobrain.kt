...
@Composable
fun GeobrainView(navegar: NavController, name: String) {
    ...
    val temaExactaManiaca = suddenDeathViewModel.temas.find { it.nombre == "GeoBrain" }
    ...
    if (preguntasRestantes.isNotEmpty()) {
        Box(
            ...
            Image(
                painter = painterResource(id = R.drawable.geobrain),
